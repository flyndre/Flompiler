...
public class MiniJavaLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"STRING", "CHAR", "JNULL", "EQUALSSTAT", "INTEGER", "COMMA", "DECREMENT", 
			"INCREMENT", "PLUS", "MINUS", "MUL", "DIV", "MOD", "PUBLIC", "PRIVATE", 
			"PROTECTED", "NAME", "WAVEDBROPEN", "WAVEDBRCLOSE", "SEMICOLON", "BROPEN", 
			"BRCLOSE", "SEQUENCE", "TIMESEQUAL", "DIVIDEEQUAL", "PLUSEQUAL", "MINUSEQUAL", 
			"WS"
		};
	}
