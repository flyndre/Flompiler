...
public class MiniJavaLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"NEW", "THIS", "WHILE", "IF", "ELSE", "DOT", "RETURN", "CLASS", "BOOLEAN", 
			"INTTYPE", "STRINGTYPE", "BOOLEANTYPE", "CHARTYPE", "VOIDTYPE", "EQUALS", 
			"STRING", "CHAR", "JNULL", "EQUALSSTAT", "OR", "LESSTHAN", "GREATERTHAN", 
			"INTEGER", "COMMA", "DECREMENT", "INCREMENT", "PLUS", "MINUS", "MUL", 
			"DIV", "MOD", "PUBLIC", "PRIVATE", "PROTECTED", "NAME", "WAVEDBROPEN", 
			"WAVEDBRCLOSE", "SEMICOLON", "BROPEN", "BRCLOSE", "SEQUENCE", "TIMESEQUAL", 
			"DIVIDEEQUAL", "PLUSEQUAL", "MINUSEQUAL", "WS"
		};
	}
